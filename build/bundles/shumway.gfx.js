...
var Shumway;
(function (Shumway) {
  Shumway.version = '0.10.227';
  Shumway.build = '34e10f9';
})(Shumway || (Shumway = {}));
    ...
    (function (GFX) {
        ...
        (function (Window) {
            ...
            var WindowEaselHost = (function (_super) {
                ...
                WindowEaselHost.prototype._sendRegisterFontOrImageResponse = function (requestId, result) {
                    this._playerWindow.postMessage({
                ...
                WindowEaselHost.prototype.onWindowMessage = function (data, async) {
                    ...
                    if (typeof data === 'object' && data !== null) {
                        if (data.type === 'player') {
                            ...
                            this.processRegisterFontOrImage(data.syncId, data.symbolId, data.assetType, data.data, this._sendRegisterFontOrImageResponse.bind(this, data.requestId));
                        }
    ...
    (function (GFX) {
        ...
        (function (Test) {
            ...
            var TestEaselHost = (function (_super) {
                ...
                TestEaselHost.prototype._sendRegisterFontOrImageResponse = function (requestId, result) {
                    this._worker.postMessage({
                        type: 'registerFontOrImageResponse',
                        requestId: requestId,
                        result: result
    ...
    (function (GFX) {
        ...
        (function (Test) {
                    ...
                    switch (typeof item) {
                        ...
                        default:
                            ...
                            if (Array.isArray(item) && (item instanceof Int32Array)) {
                                ...
                                if (item.buffer instanceof ArrayBuffer && (typeof item.byteOffset === 'number')) {
            ...
            (function (MovieRecordType) {
                ...
                MovieRecordType[MovieRecordType["FontOrImage"] = 4] = "FontOrImage";
                MovieRecordType[MovieRecordType["FSCommand"] = 5] = "FSCommand";
            ...
            var MovieRecordParser = (function () {
                ...
                MovieRecordParser.prototype.parseFontOrImage = function () {
    ...
    (function (GFX) {
        ...
        (function (Test) {
            ...
            var PlaybackEaselHost = (function (_super) {
                ...
                PlaybackEaselHost.prototype.requestTimeline = function (type, cmd) {
                ...
                PlaybackEaselHost.prototype._runRecord = function () {
                    ...
                    switch (this._parser.currentType) {
                        ...
                        case 4 /* FontOrImage */:
                            ...
                            this.processRegisterFontOrImage(data.syncId, data.symbolId, data.assetType, data.data, function () {
                            });
                            break;
                        case 5 /* FSCommand */:
    ...
    (function (GFX) {
        ...
        (function (Test) {
            var RecordingEaselHost = (function (_super) {
                ...
                function RecordingEaselHost(easel, recordingLimit) {
                ...
                RecordingEaselHost.prototype._onWorkerMessage = function (e, async) {
                    if (async === void 0) { async = true; }
                    var data = e.data;
                    if (typeof data !== 'object' || data === null) {
                        return;
                    ...
                    switch (type) {
                        ...
                        case 'frame':
                            ...
                            break;
                        case 'registerFontOrImage':
                            this._recorder.recordFontOrImage(data.syncId, data.symbolId, data.assetType, data.data);
                            break;
                        case 'fscommand':
                            this._recorder.recordFSCommand(data.command, data.args);
                            break;
                    }
                    _super.prototype._onWorkerMessage.call(this, e, async);
                };
